...
public class CustomUserDetailsService implements UserDetailsService {
  ...
  private UserDetails loadUserByTag(String cellphone) {
    UserDetails userDetails = memberRepository.findByCellphone(cellphone)
        .orElseThrow(() -> new UsernameNotFoundException("cellphone에 해당하는 사용자를 찾을 수 없습니다."));
    if (userDetails == null) {
      throw new UsernameNotFoundException("cellphone에 해당하는 사용자를 찾을 수 없습니다.");
    }
    return userDetails;
  }
